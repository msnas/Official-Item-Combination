	...
	(
		{
			...
			(
				...
				## Slot
				{
					...
					"slot" : (
						{"index":0, "x":78, "y":12, "width":31, "height":31},  # scroll
					),
				},
				
				{
					"name" : "CombSlot", # In order to make the lower slot visible only when the scroll is attached, it was written separately from the Scroll slot.
					"type" : "slot",
					...
					"slot" : (
						{"index":1, "x":28, "y":8, "width":31, "height":96},  # main costume
						{"index":2, "x":129, "y":8, "width":31, "height":96}, # Material Costume
						{"index":3, "x":79, "y":125, "width":31, "height":96}, # Result Costume
					),
